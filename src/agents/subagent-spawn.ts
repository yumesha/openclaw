...
export async function spawnSubagentDirect(
  ...
  // When spawning with a specific agentId, use that agent's workspace
  // Otherwise inherit from the requester
  const targetWorkspaceDir = targetAgentId !== requesterAgentId
